...
exports.default = function (json, update, vis, force, node, link) {
  ...
  d3.select('#login-button-submit').on('click',function(){
            ...
            d3.select("g#node-" + newNodeId).attr("transform", "translate(" + tx + "," + ty + ")").datum(Object.assign(d3.select("g#node-" + newNodeId).data()[0], { "x": tx, "y": ty }));
                ...
                x = _d3$mouse2[0],
                y = _d3$mouse2[1];
             var newNode = { "id": "", "group": "","nodeNote":"","nodeTitle":"",isNew: true };
              json.nodes.push(newNode);
              update(json);
      	}
				}else{
...
exports.default = function (json, vis) {
    ...
    node.append("svg:image").attr("class", "node-icon").attr("xlink:href", _node2.default).attr("x", "-13px").attr("y", "-13px").attr("width", "25px").attr("height", "25px");
    ...
    }).attr("text-anchor", "middle").attr("font-size", "16px").attr("fill", "#286090").html(function (d) {
        return d["group"];
    });
...
exports.default = function (json, update, vis, node, link) {
    ...
    node.on("contextmenu", function (d) {
        d.contextmenuData = {
            "title": "操作当前节点",
             "list": [{ "class": "node-del", "text": "删除节点" },{ "class": "update-node", "text": "修改节点" }]
        };
